...
const testReportDoc = `# Niramaya Setu - Frontend Security Test Report
...
fs.writeFileSync("FRONTEND_SECURITY_TEST_REPORT.md", testReportDoc, "utf8");
console.log("Created FRONTEND_SECURITY_TEST_REPORT.md");
