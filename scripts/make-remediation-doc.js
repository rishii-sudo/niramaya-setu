...
const remediationDoc = `# Niramaya Setu - Frontend Security Remediation Report
...
fs.writeFileSync("FRONTEND_SECURITY_REMEDIATION.md", remediationDoc, "utf8");
console.log("Created FRONTEND_SECURITY_REMEDIATION.md");
